...
เวอร์ชันปัจจุบันคือ **v0.7.0** (2026-08-07) โดยทำให้เกณฑ์จำแนกขนาดงาน (S / M / L / H / Epic, L2-1 ใน [docs/01](docs/01-milestone-loop.md)) กลายเป็นตัวบทสัญญา — ตัดสินด้วยตารางนิยามขนาดบวกสามแกน (ขอบเขตผลกระทบ ความย้อนกลับไม่ได้ ระยะเวลา) และเมื่อไม่แน่ใจให้ปัดไปทางหนักกว่า อินพุตของจำนวนที่นั่งรีวิว (L1-11) และประตูเข้า Epic (E-1) จะไม่ต้องพึ่งความรู้โดยนัยของผู้นำไปใช้อีกต่อไป
