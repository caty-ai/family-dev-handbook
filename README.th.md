...
เวอร์ชันปัจจุบันคือ **v0.6.0** (2026-08-07) โดยเพิ่มชั้นวงจรชีวิตเวิร์กสเปซ (`LC-1`–`LC-5`, [docs/08](docs/08-lifecycle.md)) เข้ามา — สัญญาว่าสิ่งที่วางไว้ในสโตร์ร่วมและพื้นที่ทำงานจะออกไปเมื่อใดและอย่างไร กำหนดทริกเกอร์การออกตั้งแต่ตอนวาง การตรวจสอบทำได้เพียงเตือน (ไม่ย้ายไฟล์เอง) และตัวเลขของเงื่อนไขการออกมีฉบับหลักอยู่ที่การตั้งค่าท้องถิ่น
