# EPIC Issue / Epic レーン テンプレート

Epic レーン（[docs/06](../docs/06-epic-lane.md)・E-1〜E-10）のフィールドスキーマの正本。単発 Issue・WIP/HOLD 等のコメント様式は [issue-template.md](issue-template.md) のまま（Epic 内の子 Issue もそちらを使う）。

## EPIC Issue 本文（E-1 / E-2 / E-3 / E-10）
...
## Epic ログ コメント（E-7 — 子 Issue の終端ごとに EPIC Issue へ）
...
## 子→epic ライトゲート記録（E-6② — 子→epic PR の本文に）
...
## Epic 終端コメント（E-9 — EPIC Issue へ。L1-4 の5語彙を適用）
