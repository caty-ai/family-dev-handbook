...
# Source: https://github.com/NousResearch/hermes-agent/blob/main/scripts/ci/assemble_review_comment.py
# Retrieved: 2026-08-09 / Changes: none (verbatim copy; this header block only)
