> **แปลโดยเครื่อง** ต้นฉบับภาษาญี่ปุ่น ([epic-template.md](../../../templates/epic-template.md)) เป็นฉบับหลัก — หากหน้านี้ขัดกับต้นฉบับ ให้ยึดข้อความภาษาญี่ปุ่นเป็นหลัก

# เทมเพลต EPIC Issue / Epic Lane

ต้นฉบับที่แท้จริงของ field schema สำหรับ Epic lane ([docs/06](../docs/06-epic-lane.md)・E-1〜E-10) รูปแบบคอมเมนต์สำหรับ Issue เดี่ยวและ WIP/HOLD ยังคงใช้ [issue-template.md](issue-template.md) เหมือนเดิม (child Issue ภายใน Epic ก็ใช้ไฟล์นั้นเช่นกัน)

## เนื้อหา EPIC Issue（E-1 / E-2 / E-3 / E-10）
...
## คอมเมนต์ Epic log（E-7 — โพสต์ไปยัง EPIC Issue ทุกครั้งที่ child Issue จบ）
...
## บันทึก light gate ของ child→epic（E-6② — ในเนื้อหา PR ของ child→epic）
...
## คอมเมนต์ปิด Epic（E-9 — โพสต์ไปยัง EPIC Issue โดยใช้คำศัพท์ 5 คำของ L1-4）
