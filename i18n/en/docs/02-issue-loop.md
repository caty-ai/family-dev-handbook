...
- **Ratchet ban for follow-up rounds** — from round 2 onward, new blocking findings are limited to demonstrated defects (with reproduction or execution-log evidence) or unmet gate criteria. Do not turn new preferences, generalities, or style wishes into late blocking findings (raising them as non-blocking is welcome). The evidence bar points the same way as the citation requirement in [R-4](09-rejection-rubric.md)
