...
<p align="center"><sub>generation: <code>ae697ea</code> (2026-08-31T05:01:43Z) · verify: <a href="https://api.github.com/repos/caty-ai/family-dev-handbook/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
...
- 既知の制約: 条文は docs のみです。`templates/` には採用先が自分の CI にコピーして使うお手本（ゲートの型・YAML+Python）をサンプルとして同梱し、`scripts/` はこのリポジトリ自身の検査用スクリプトです。また、タイ語ミラーの既知のリンク2件を [#89](https://github.com/caty-ai/family-dev-handbook/issues/89) で追跡しています。
