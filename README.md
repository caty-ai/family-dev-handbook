...
Two starting points are worth sharing before you read on. Everything below stands on both of them.
...
1. Open the "distribution summary block" in [docs/04](docs/04-adoption.md) — it is about 30 lines of text
...
The rules fall into five families, and every one of them carries an ID that does not change. Summaries, conversations, and Issues all point at each other through those IDs.
...
The current version is **v0.3.0** (2026-07-31). It added the Epic lane (`E-1`–`E-10`) and upstream heterogeneous review before implementation begins (`L1-9`–`L1-11`).
...
| **Family Dev Handbook** | The rules of the road — issues, PRs, worktrees, handoffs, parallel development | published, MIT |
