...
<p align="center"><sub>generation: <code>5ddf454</code> (2026-09-07T18:45:29Z) · verify: <a href="https://api.github.com/repos/caty-ai/family-dev-handbook/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
